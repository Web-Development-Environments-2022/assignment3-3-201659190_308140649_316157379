<template>
    ...
    <b-modal id="recipeCreation" title="Create new recipe" @show="resetModal" @hidden="resetModal" hide-footer>
      ...
      <b-form-group label="Enter recipe title" label-for="recipeTitle" >
        <b-form-input id="recipeTitle" v-model="recipe.title" :state="recipeTitleState" required></b-form-input>
      ...
      <b-form-group >
        <div v-for="(ingredientStep, i) in recipe.ingredients" :key="i">
          Add ingredient:
          <b-form-input v-model="ingredientStep.ingredient" placeholder="ingredient" :state="recipeIngredientState(ingredientStep.ingredient)"></b-form-input>
          <b-form-invalid-feedback>
            Enter at least 1 character
          </b-form-invalid-feedback>
          <br>
...
export default {
  ...
  methods: {
    ...
    recipeIngredientState(ingredient){
      return ingredient.length === 0 ? false : true;
    },
